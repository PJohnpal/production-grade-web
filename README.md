...
Interactive Analytics Dashboard - Displays key metrics, trends, and visualizations for invoice and vendor data
Chat with Data Interface - Enables natural language queries against the dataset using AI
